...
public class MainActivity extends AppCompatActivity {
    ...
    private static int xx, yy, xx1, yy1, count, count1, xx2, yy2, count2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button horizontalFlipButton = findViewById(R.id.horizontal_button);
        Button verticalFlipButton = findViewById(R.id.vertical_button);
        mImageView = findViewById(R.id.image);
        textView = findViewById(R.id.textView);
        horizontalFlipButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BitmapDrawable mydrawable = (BitmapDrawable) mImageView.getDrawable();
                ...
                textView.setText(String.valueOf("("+ xx + ", " + yy + ")  " + "count: " + count + "\n" +"("+ xx1 + ", "+ yy1 + ") " +
